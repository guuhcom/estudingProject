...
namespace projetoIntegrador.Repository
{
    public class UsuarioStore : IUsuario
    {
        ...
        public Usuario GetUsuarioByName(string nomeUsuario) =>
            _context.Usuarios.Include(u => u.Nivel).FirstOrDefault(u => u.NOME_USU == nomeUsuario.ToLower());

        public Usuario GetUsuarioById(int id) =>
            _context.Usuarios.Include(u => u.Nivel).FirstOrDefault(u => u.IDNIV_USU == id);

        public Usuario GetUsuarioByMatricula(int matriculaUsuario) =>
            _context.Usuarios.Include(u => u.Nivel).FirstOrDefault(u => u.MATRICULA_USU == matriculaUsuario);
